...
def test(params):
	...
	## fix this, to ensure that RayGenerator can be used to render random phase optic for test data
	rg = RayGenerator(params['datapath'], half_res=params['half_res'], phase_dict=params['phase_optic'])
